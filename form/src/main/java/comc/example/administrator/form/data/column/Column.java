package comc.example.administrator.form.data.column;
...
import comc.example.administrator.form.data.TableInfo;
import comc.example.administrator.form.data.format.IFormat;
import comc.example.administrator.form.data.format.count.DecimalCountFormat;
import comc.example.administrator.form.data.format.count.ICountFormat;
import comc.example.administrator.form.data.format.count.NumberCountFormat;
import comc.example.administrator.form.data.format.count.StringCountFormat;
import comc.example.administrator.form.data.format.draw.FastTextDrawFormat;
import comc.example.administrator.form.data.format.draw.IDrawFormat;
import comc.example.administrator.form.data.format.draw.MultiLineDrawFormat;
import comc.example.administrator.form.data.format.draw.TextDrawFormat;
import comc.example.administrator.form.listener.OnColumnItemClickListener;
