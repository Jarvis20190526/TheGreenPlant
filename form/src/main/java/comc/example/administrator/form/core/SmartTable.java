package comc.example.administrator.form.core;
...
import comc.example.administrator.form.component.ITableTitle;
import comc.example.administrator.form.component.TableProvider;
import comc.example.administrator.form.component.TableTitle;
import comc.example.administrator.form.component.XSequence;
import comc.example.administrator.form.component.YSequence;
import comc.example.administrator.form.data.TableInfo;
import comc.example.administrator.form.data.column.Column;
import comc.example.administrator.form.data.format.selected.ISelectFormat;
import comc.example.administrator.form.data.style.FontStyle;
import comc.example.administrator.form.data.table.PageTableData;
...
import comc.example.administrator.form.listener.OnTableChangeListener;
import comc.example.administrator.form.matrix.MatrixHelper;
