...
import comc.example.administrator.form.annotation.ColumnType;
import comc.example.administrator.form.annotation.SmartColumn;
import comc.example.administrator.form.data.column.ArrayColumn;
import comc.example.administrator.form.data.column.Column;
import comc.example.administrator.form.data.table.PageTableData;
import comc.example.administrator.form.exception.TableException;
    ...
    public PageTableData<T> parse(List<T> dataList){
        if(dataList!= null && dataList.size() >0) {
            ...
            if(firstData != null) {
                ...
                Annotation tableAnnotation = clazz.getAnnotation(comc.example.administrator.form.annotation.SmartTable.class);
                if(tableAnnotation != null){
                    comc.example.administrator.form.annotation.SmartTable table = (comc.example.administrator.form.annotation.SmartTable) tableAnnotation;
