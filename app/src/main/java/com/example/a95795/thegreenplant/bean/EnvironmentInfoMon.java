...
public class EnvironmentInfoMon {
    ...
    public static class EnvironmentInfoListBean {
        ...
        public EnvironmentInfoListBean(String emName, int tmp, int hum, int pm, boolean isTmp, boolean isHum, boolean isPm, String monTime, boolean isEvent) {
            this.emName = emName;
            this.tmp = tmp;
            this.hum = hum;
            this.pm = pm;
        ...
        public int getMonEmId() {
            return monEmId;
        }

        public void setMonEmId(int monEmId) {
            this.monEmId = monEmId;
        }
