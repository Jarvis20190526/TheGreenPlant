...
public class WeekWorkShop4ChartFragment extends Fragment {
    private View view;
    private LineChart chart;
    private WeekDynamicLineChartManager dynamicLineChartManager;
    ...
    public void initView(){
        ...
        dynamicLineChartManager = new WeekDynamicLineChartManager(chart, names, colour);
    ...
    public void getEnvironmentInfoList() {
        ...
        Call<EnvironmentInfoWeek> einfo= openApiService.queryEnvironmentInfoWeekByType4();
        ...
        einfo.enqueue(new Callback<EnvironmentInfoWeek>() {
            ...
            public void onResponse(Call<EnvironmentInfoWeek> call, retrofit2.Response<EnvironmentInfoWeek> response) {
                ...
                for(int j=0;j<ef.getEnvironmentInfoList().size();j++){
                    ...
                    dynamicLineChartManager.addEntry4(listData);
                    listData.clear();
                }
            }
            @Override
