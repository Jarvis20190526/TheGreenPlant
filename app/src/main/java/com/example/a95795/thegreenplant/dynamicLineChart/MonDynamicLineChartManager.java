...
public class MonDynamicLineChartManager {
    ...
    //一条曲线
    public MonDynamicLineChartManager(LineChart mLineChart, String name, int color) {
    ...
    public MonDynamicLineChartManager(LineChart mLineChart, List<String> names, List<Integer> colors) {
        this.lineChart = mLineChart;
        leftAxis = lineChart.getAxisLeft();
        rightAxis = lineChart.getAxisRight();
        xAxis = lineChart.getXAxis();
